...
<section class="container-fluid articlesBG"> <!-- LATEST ARTICLES -->
    <div class="container">
<h3 class="text-center">LATEST ARTICLES</h3>
<div class="row">

    <div class="col-md-4"> <!-- 4/12 SECTION 1 --> 
        <img class="img-fluid" src="http://170.187.231.66/~mesh12/ wp-content/themes/starter_for_josh_site/images/game.jpg" alt="Portrait of a woman created by the designer"> 
        <h3 class="article-title"> A PORTRAIT </h3>
...
<a href="#">CONTINUE READING</a>
        ...
        <div class="col-md-4"> <!-- 4/12 SECTION 2 -->
            <img class="img-fluid" src="http://170.187.231.66/~mesh12/ wp-content/themes/starter_for_josh_site/images/game.jpg" alt="Portrait of a woman created by the designer"> 
<h3 class="article-title"> A PORTRAIT </h3>
<p class="article-date">Friday,November 10. 2030</p>
<p class="article-paragraph">
...
<a href="#">CONTINUE READING</a>
         ...
         <div class="col-md-4"> <!-- 4/12 SECTION 3 -->
             <img class="img-fluid" src="http://170.187.231.66/~mesh12/ wp-content/themes/starter_for_josh_site/images/game.jpg" alt="Portrait of a woman created by the designer"> 
 <h3 class="article-title"> A PORTRAIT </h3>
  <p class="article-date">Friday,November 10. 2030</p>
  <p class="article-paragraph">
